    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_level', models.CharField(choices=[(1, 'superuser'), (2, 'admin'), (3, 'basic'), (4, 'high level clinician'), (5, 'medium level clinician'), (6, 'low level clinician')], default=3, max_length=50)),
